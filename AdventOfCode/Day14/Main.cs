...
namespace AdventOfCode.Day14
{
    public static class Main
    {
        ...
        {
            var parser = new InitParser();

            Console.WriteLine($"The test program sum is {parser.Parse_v1(test1)} (165)");
            Console.WriteLine($"The program sum is {parser.Parse_v1(data)}");

            Console.WriteLine($"The test program sum is {parser.Parse_v2(test2)} (208)");
            Console.WriteLine($"The program sum is {parser.Parse_v2(data)}");
        }

        private static List<string> test1 = new List<string>
        {
        ...
        private static List<string> test2 = new List<string>
        {
